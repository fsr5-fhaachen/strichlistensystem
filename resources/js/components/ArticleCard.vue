<template>
    <div
        class="bg-gray-100 border-gray-500 dark:bg-gray-800 dark:border-gray-900 border-2 w-full rounded-lg p-8 gap-8 cursor-pointer flex flex-col"
    >
        ...
        <div
            ...
            v-if="article.max_order_amount > 1"
        >
            <button
                @click="removeAmount"
                :disabled="amount <= 1"
        ...
        <button
            class="mt-auto bg-green-500 dark:bg-green-700 hover:bg-green-700 dark:hover:bg-green-900 px-4 py-2 text-2xl md:text-4x rounded-lg disabled:opacity-10"
            @click="buy"
            :disabled="disabled"
        >
            BUCHEN!
